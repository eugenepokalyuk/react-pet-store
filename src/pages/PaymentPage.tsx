                                            ...
                                            {paymentMethod && (
                                                <>
                                                        ...
                                                        <label className="block mb-2">
                                                            <div className="mt-4">
                                                                ...
                                                                <input
                                                                    type="email"
                                                                    id="email"
                                                                    className="w-full rounded-lg border py-2 px-3 border-[#3b444b]/80  outline-none"
                                                                    value={email}
                                                    ...
                                                    <motion.button
                                                        ...
                                                        whileTap={{ scale: 0.9 }}
                                                        className="bg-[#3b444b]/80 text-white px-4 py-2 rounded-lg"
