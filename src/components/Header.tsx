                ...
                <Grid columns='2' className="justify-center">
                    ...
                    <Flex className="justify-end">
                        ...
                        >
                            <Link
                                to="/contacts"
                                className={`text-gray-800 dark:text-white focus:ring-4 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none ${isScrolled ? 'bg-[#3b444b]' : 'bg-white/10'}`}
                            >Contacts</Link>
                        </motion.button>
                    </Flex>
                </Grid>
